...
class ExperimentImageNetVID(object):
    r"""Experiment pipeline and evaluation toolkit for VID dataset.
    ...
    def __init__(self, root_dir, subset='train',
        ...
        super(ExperimentImageNetVID, self).__init__()
        self.dataset = ImageNetVID(root_dir, subset=subset)
        self.result_dir = os.path.join(result_dir, 'ImageNetVID')
        self.report_dir = os.path.join(report_dir, 'ImageNetVID')
